...
<body>
	<div class="container">
		<div class="row">
			<h1 class="text-primary">${board.bno }번글 내용</h1>
			<form class="form-group">
				...
				<!-- button태그는 말 그대로 버튼을 만들어주는 태그
					 ...
					 정보가 제공되도록 합니다.-->
				<button type="submit" data-oper="modify" class="btn btn-warning board">수정</button>
				<button type="submit" data-oper="remove" class="btn btn-danger board">삭제</button>
				<a
					href="/board/list?page=${cri.page }&searchType=${cri.searchType}&keyword=${cri.keyword}"
			...
			<div class="row box-box-success">
				<div class="box-header">
					...
					<div class="box-body">
						<strong>Writer</strong> <input type="text" id="newReplyer"
							placeholder="Replyer" class="form-control"> <strong>ReplyText</strong>
						<input type="text" id="newReplyText" placeholder="ReplyText"
							class="form-control">
					</div>
					<div class="box-fotter">
						<button type="button" class="btn btn-success" id="replyAddbtn">Add
							reply</button>
					</div>
				</div>
